...
class ScLB3Sc6Sc(Mode):
    def __init__(self):
        Mode.__init__(self, f"Score 3 - Zone 3")
        self.pathCmd1 = DrivePathCommand("ZoneC_Score3.1")
        self.pathCmd2 = DrivePathCommand("ZoneC_Score3.2")
        self.pathCmd3 = DrivePathCommand("ZoneC_Score3.3")
